...
DEBUGDIR=/fh/scratch/delete10/gottardo_r/hmiller/$DATASET
...
Rscript process.R -i $INDAT -o $OUTDAT -d $DEBUGDIR -r $REFERENCEDAT --plotdir $PLOTDIR --hpath $H5OUT -b $batch
